...
{
    app.UseExceptionHandler("/Home/Error"); // Handles exceptions (500 errors)
...
// Middleware to handle 404 Not Found errors by re-executing the request to a custom page
// IMPORTANT: Place this before UseRouting
